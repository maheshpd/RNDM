...
class Thought {
    ...
    class func parseData(snapshot: QuerySnapshot?) -> [Thought] {
        ...
        for document in snap.documents {
            ...
            let newThought = Thought(username: username, timestamp: timestamp, thoughtTxt: thoughtTxt, numLikes: numLikes,
                                     numComments: numComments, documentId: documentId, userId: userId)
